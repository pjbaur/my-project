...
**YOU ARE IN: `my_project/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/my_project/` (rig root) or other directories
...
**Your mail address:** `my_project/polecats/obsidian`
**Your rig:** my_project
**Your Witness:** `my_project/witness`
...
| Ask Witness for help | `gt mail send my_project/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`my_project/witness`) when:
...
```bash
gt mail send my_project/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
